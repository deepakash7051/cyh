...
return [
    ...
    'tamil'  =>  'Tamil',
    'onewaysms' => [
        'invalid_details' => 'apiusername or apipassword is invalid',
        'invalid_senderid' => 'Senderid parameter is invalid',
        'invalid_phone' => 'Phone number parameter is invalid',
        'invalid_language_type' => 'language Type is invalid',
        'invalid_character' => 'Invalid characters in message',
        'low_balance' => 'Insufficient credit balance',
        'unknown' => 'Unknown reason', 
        'credentials_not_set' => 'Auth credentials is not set',
        'success' => 'Success',
    ],
    'vimeo_youtube_video' => 'Vimeo/Youtube video link',
    ...
    'pages' => [
        'frontend'  => [
            ...
            'exam' => [
                ...
                'learn_course_again' => 'Learn Course Again',
                'learn_module_again' => 'Learn Module Again',
            ],
        ],
    ],
    'userManagement'                       => [
